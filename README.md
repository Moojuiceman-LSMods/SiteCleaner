...
Adds keybinds for cleaning tools and materials from the build site, as happens when someone moves in.
...
* Clean Tools Key - Keybind to cleanup tools
* Clean Materials Key - Keybind to cleanup materials